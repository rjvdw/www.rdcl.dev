...
import { Board, ConnectFourState } from '../../../modules/connectFour'

type ConnectFourProps = ConnectFourState & {
  board: Board,
  reset: () => void,
  move: (col: number) => void,
}

export const ConnectFour = ({ board, activePlayer, nrRows, nrCols, invalidMove, gameOver, winner, move, reset }: ConnectFourProps) => <>
  <h1>Connect Four</h1>
